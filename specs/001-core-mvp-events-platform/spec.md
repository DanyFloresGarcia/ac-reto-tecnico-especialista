...
- El envío real de correos está fuera de alcance; simular la comunicación saliente (por ejemplo, dejar constancia de su contenido en los registros del sistema) satisface el requisito de "notificar" para este MVP.
